        ...
        <div className="flex flex-wrap justify-center gap-6">
          {uniqueTechnologies.map((tech) => (
            <div key={tech} className="group relative flex flex-col items-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-secondary/10 dark:bg-secondary/5 p-3 transition-transform duration-300 group-hover:scale-110">
                <TechIcon name={tech} className="h-8 w-8 text-secondary dark:text-secondary" />
              </div>
